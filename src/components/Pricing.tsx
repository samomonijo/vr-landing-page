    ...
    <div className="mt-20">
      ...
      <div className="flex flex-wrap items-stretch justify-center">
        {pricingOptions.map((option, index) => {
          return (
            <div key={index} className="w-full sm:w-1/4 lg:w-1/3 p-2">
              <div className="p-8 border border-neutral-700 rounded-xl">
                <p className="text-2xl mb-8">
                  {option.title}

                  {option.title === "Pro" && (
                    <span className="bg-linear-to-r from-orange-500 to-red-400 text-transparent bg-clip-text text-xl mb-4 ml-2">(Most popular)</span>
                  )}
                </p>
