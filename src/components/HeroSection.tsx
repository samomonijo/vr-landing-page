  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      <div className="flex justify-center my-10">
        <a href="#" className="bg-linear-to-r text-center from-orange-500 to-orange-800 py-3 px-4 mx-3 rounded-md">
          Start for free
        </a>

        <a href="#" className="py-3 px-4 mx-3 text-center flex items-center justify-center rounded-md border">
          Documentation
        </a>
      </div>
